...
robo::serial::serial_interface::serial_interface(const std::string &path) : serial_port(io_context), path(path) {}

void robo::serial::serial_interface::open(uint32_t baud, size_t character_size, robo::serial::parity_option parity,
